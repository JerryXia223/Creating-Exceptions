In this code, I created three Circle objects and test them with different radius values. If the radius is invalid (negative or zero), an InvalidRadiusException is thrown and caught in the Main class.
